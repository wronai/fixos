...
class NLPIntent(BaseModel):
    ...
    intent_type: str = Field(description="Typ intencji: scan, fix, cleanup, status, help, unknown")
    target: Optional[str] = Field(default=None, description="Cel polecenia, np. 'docker', 'audio'")
