...
### fixos.cli.config_cmd.config_provider
> Interaktywnie wybierz providera LLM z listy.
- **Calls**: config.command, FixOsConfig.load, click.echo, click.echo, click.echo, click.echo, click.echo, click.echo
...
### Flow 2: config_provider
```
config_provider [fixos.cli.config_cmd]
```
...
### Flow 6: _print_quick_issues
```
_print_quick_issues [fixos.cli.scan_cmd]
```

### Flow 7: diagnose_security
```
...
- `fixos.cli.config_cmd.config_provider` - 59 calls
...
graph TD
    orchestrate --> command
    orchestrate --> option
    config_provider --> command
    config_provider --> load
    config_provider --> echo
